...
export default function RestaurantCard({ restaurant }) {
  ...
  return (
    <Link
      to={`${createPageUrl("RestaurantDetail")}?id=${
    ...
    >
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group cursor-pointer border border-gray-100 hover:-translate-y-1">
        {/* Image */}
        <div className="relative h-44 overflow-hidden bg-gradient-to-br from-emerald-100 to-lime-100">
          {restaurant.image ? (
            <img
        ...
        {/* Info */}
        <div className="p-4">
          <h3 className="font-bold text-gray-900 text-base truncate group-hover:text-emerald-600 transition-colors">
            {restaurant.name}
          </h3>
